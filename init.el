...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:height 150 :width normal :foundry "nil" :family "PragmataPro"))))
 '(linum ((t (:foreground "#DFAF8F" :height 90)))))
